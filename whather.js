...
async function getWeather(city) {
  try {
    ...
    weatherElement.innerHTML = `Температура в ${city}: ${data.main.temp}°C.<br> Ощущается как ${data.main.feels_like}°C. <br> Давление: ${data.main.pressure}.<br> Скорость ветра: ${data.wind.speed} м/с.`;
  } catch (error) {
